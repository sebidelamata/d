...
start = datetime.datetime(2015, 6, 15)  # year, month, day
end = datetime.datetime.today()  # year, month, day

# only edit these if you're having problems
delay = 4  # time to wait on each page load before reading the page
driver = webdriver.Chrome(r'C:\Users\sebid\OneDrive\Desktop\chromedriver')  # options are Chrome() Firefox() Safari()


# don't mess with this stuff
twitter_ids_filename = r'C:\Users\sebid\OneDrive\Desktop\all_ids.json'
